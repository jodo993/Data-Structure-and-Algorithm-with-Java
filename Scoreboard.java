...
public class Scoreboard {
  ...
  public void add(GameEntry e) 
  {
    ...
    if (numEntries < maxEntries || newScore > board.last().getScore())
    {
        ...
        if (board.isEmpty() || newScore > board.first().getScore())
            board.addFirst(e);
    }
    else
    {
        System.out.println("Score doesn't qualify to be added.");
    }
...
//      board[j] = e;                         // when done, add new entry
  ...
  public void remove(GameEntry e) throws IndexOutOfBoundsException 
  {
      boolean found = false;
//    if (i < 0 || i >= numEntries)
